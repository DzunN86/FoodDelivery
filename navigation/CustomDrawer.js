...
const CustomDrawerContent = ({navigation, selectedTab, setSelectedTa}) => {
  return (
    <DrawerContentScrollView
      scrollEnabled={true}
...
const CustomDrawer = ({selectedTab, setSelectedTab}) => {
  ...
  const animateStyle = {borderRadius, transform: [{scale}]};
        ...
        drawerContent={props => {
          ...
          return (
            <CustomDrawerContent
              ...
              setSelectedTa={setSelectedTab}
            />
          );
        }}>
        <Drawer.Screen name="MainLayout">
          {props => (
            <MainLayout {...props} drawerAnimationStyle={animateStyle} />
          )}
        </Drawer.Screen>
      </Drawer.Navigator>
    </View>
